  ...
  return (
    <>
      ...
      <div className="px-20 py-6">
        {/* Introduction */}
        <div className="flex flex-col justify-center items-center lg:flex-row rounded-2xl overflow-hidden w-full">
          {/* Text */}
          <div className="w-full lg:w-[40%] flex flex-col p-4">
            <span
              style={{ fontFamily: "'Libre Baskerville', serif", fontWeight: 400 }}
              className="text-stone-900 text-8xl md:text-6xl text-wrap"
            >
              Dal 2025
            </span>
            <span
              style={{ fontFamily: "'Libre Baskerville', serif", fontWeight: 400 }}
              className="text-stone-700 text-7xl md:text-5xl text-wrap"
            >
